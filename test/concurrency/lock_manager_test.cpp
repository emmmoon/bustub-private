...
TEST(LockManagerTest, MixedTest) {
  ...
  std::cout << "Try to create Table test1." << std::endl;
  bustub->ExecuteSql(schema, writer);
  std::cout << "create Table test1." << std::endl;
  ...
  std::cout << "Insert " << num << "rows into Table test1." << std::endl;
  std::cout << "Try to create Table test2." << std::endl;
